Tela inicial-Layout PyQT 4.2 - Pendente de testes.
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Adicionar dicionário para armazenar vínculos entre abas
        self.tab_links = {
            0: {'proposta': '', 'atendimento': '', 'corretor': '', 'cpf_cnpj': '', 'email': ''},
            1: {'proposta': '', 'atendimento': '', 'corretor': '', 'cpf_cnpj': '', 'email': ''},
            2: {'proposta': '', 'atendimento': '', 'corretor': '', 'cpf_cnpj': '', 'email': ''}
        }
    ...
    def update_tab_info(self, index, atendimento, corretor, proposta, cpf_cnpj, email):
        """Atualiza as informações vinculadas entre as abas do chat e navegador"""
        # Atualiza o dicionário de vínculos
        self.tab_links[index] = {
            'proposta': proposta,
        ...
        # Atualiza a informação na aba correspondente do navegador
        if hasattr(self, 'browser_tabs'):
            self.browser_tabs.update_tab_info(index, self.tab_links[index])
